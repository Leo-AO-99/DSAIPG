...
public class RandomWalk {
     ...
     *             args[0] specifies the number of steps for a random walk
     *             (required),
     *             and args[1] optionally specifies the number of experiments
     *             (default is 30).
     *             If args is empty, the method throws a RuntimeException indicating
     *             invalid syntax.
     */
